...
def plot_chart():
    ...
    colors = plt.get_cmap('gist_rainbow', len(pivot_table.columns)) #TODO: change the colormap

    #TODO: Create the bar chart
    ax = ...(kind='...', figsize=(10, 6), color=[colors(i) for i in range(len(pivot_table.columns))])

    # Adding titles and labels - more in the next step
